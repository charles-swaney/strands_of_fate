...
class GuardBreak(Skill):
    def __init__(self):
        """
        Deals moderate damage, with a chance of lowering the target's toughness.
        ...
        for target in targets:
            ...
            if hit_roll < hit_chance:
                ...
                if debuff_roll < debuff_chance:
                    value = target.toughness * 0.40
                    target.total_stats.update(Attributes({"toughness": -value}))
